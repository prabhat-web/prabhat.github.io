...
var AccountListComponent = /** @class */ (function () {
    ...
    AccountListComponent.prototype.basicLoad = function () {
        if (this.accountDetails.length > 3) {
            this.array1 = this.accountDetails.slice(0, 3);
            this.array2 = this.accountDetails.slice(3);
        }
    };
    AccountListComponent.prototype.loadMe = function () {
        this.accLoaded = true;
        this.showMe = false;
    };
    AccountListComponent.prototype.sortByName = function () {
        this.nameCount += 1;
        if (this.nameCount % 2 == 0) {
            this.accountDetails.sort(function (a, b) { return b.account.localeCompare(a.account); });
        }
        else {
            this.accountDetails.sort(function (a, b) { return a.account.localeCompare(b.account); });
        }
        this.basicLoad();
    };
    AccountListComponent.prototype.sortByNo = function () {
        this.noCount += 1;
        if (this.noCount % 2 == 0) {
            this.accountDetails.sort(function (a, b) { return b.cash - a.cash; });
        }
        else {
            this.accountDetails.sort(function (a, b) { return a.cash - b.cash; });
        }
        this.basicLoad();
    };
